...
namespace Lithnet.Transforms.Presentation
{
    public class TransformCollectionViewModel : ListViewModel<TransformViewModel, Transform>
    {
        ...
        private static Type GetViewModelType(object model, Type modelType)
        {
            ...
            Type viewModelType = Type.GetType("Lithnet.Transforms.Presentation." + modelTypeName + "ViewModel");
            ...
            {
                return Type.GetType("Lithnet.Transforms.Presentation." + modelTypeName + "ViewModel");
            }
        }
    }
}