...
{
    public class JoinMappingActionGroupViewModel : ActionGroupViewModel
    {
        public JoinMappingActionGroupViewModel(ActionGroup model)
            : base(model)
        {
            ...
            this.Commands.AddItem("AddJoinMappingAction", t => this.Actions.AddJoinMappingAction());
